...
import 'package:urluab/animation/fade_animation.dart';
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: Colors.black87.withOpacity(.3), borderRadius: const BorderRadius.all(Radius.circular(10))),
                child: const Center(
                  child: Icon(
                          ...
                          children: [
                            ...
                            RichText(
                              text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(
                                      text: _travelList[widget.id].cost.toString(),
                          ...
                          children: [
                            ...
                            RichText(
                              text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(
                                      text: '(' + _travelList[widget.id].distance.toString() + 'km)',
                                      style: const TextStyle(
                                        color: Colors.black,
                                      ),
                                    ),
