...
class _PlanSiwaState extends State<PlanSiwa> {
  Future fetchPeople() async {
    String jsonString = await rootBundle.loadString('assets/siwa.json');
    //print(jsonString);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        //             borderRadius: BorderRadius.circular(30.0),
        //             child: Image(
        //               image: AssetImage("assets/siwaa.jpg"),
        //               fit: BoxFit.cover,
        //             ),
        //           ),
        //         ),
        ...
        //                   child: Image(
        //                     width: 110.0,
        //                     image: AssetImage("assets/hottel1.jpg"),
        //                     fit: BoxFit.cover,
        //                   ),
        //                 ),
        //               ),
