...
import 'package:urluab/Screens/logg.dart';
import 'package:urluab/Screens/Splash.dart';
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => SplashScreen(title: "Splash Screen")));
                },
              ),
              ListTile(
